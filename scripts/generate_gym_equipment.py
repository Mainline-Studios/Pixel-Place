...
print("="*50)
print("\nOption 1: Export All Together")
print("  - Press 'A' to select all objects")
print("  - File > Export > glTF 2.0 (.glb/.gltf)")
print("  - Export as single file (e.g., 'gym_equipment.glb')")
print("\nOption 2: Export Separately (Recommended)")
print("  - Select individual objects (click to select)")
print("  - Export each as separate .glb file:")
print("    * Barbell → 'barbell.glb'")
print("    * Bench → 'bench.glb'")
print("    * Weight Plates → 'weight_plates.glb'")
print("    * Dumbbells → 'dumbbells.glb'")
