  ...
  return (
    <>
      ...
      {(user.role === 'admin' || user.role === 'head_admin') && (
        <div className="ai-box" style={{ marginTop: '20px', border: '2px solid #34f5c5' }}>
          <div className="ai-label" style={{ color: '#34f5c5' }}>Admin Exclusive</div>
          <div className="coins-store-row">
            <div className="coin-pack" style={{ border: '2px solid #34f5c5' }}>
              <div className="coin-amount" style={{ fontSize: '24px', color: '#34f5c5' }}>
              ...
              <button
                ...
                style={
                  user.username === '6767kid' ? { background: '#34f5c5', color: '#05050a' } : undefined
                }
              >
