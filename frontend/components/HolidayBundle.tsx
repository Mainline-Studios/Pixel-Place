...
import { getSkins, getAccessories, saveSkins, saveAccessories, isPrimaryOpsAdmin } from '@/lib/storage';
...
export default function HolidayBundle({ user, onClose }: HolidayBundleProps) {
    ...
    const handlePurchase = async () => {
        ...
        // Free bundle for primary ops account
                ...
                {!hasPurchased ? (
                    <div>
                        ...
                        <button
                            ...
                            style={{
                                padding: '15px 40px',
                                backgroundColor: isPrimaryOpsAdmin(user.username) ? '#00aaff' : holiday.color,
                                color: '#fff',
                                border: 'none',
                                borderRadius: '10px',
                                cursor: 'pointer',
                        ...
                        >
                            {isPrimaryOpsAdmin(user.username) ? 'Get Bundle FREE' : 'Purchase Bundle - $30'}
                        </button>
