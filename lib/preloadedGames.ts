          ...
          if (data.success) {
            ...
            const newInterval = setInterval(() => {
              ...
              if (hasSocket) {
                ...
                clearInterval(newInterval);
                const timeoutHtml = '<div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); min-height: 100vh; display: flex; align-items: center; justify-content: center; padding: 20px; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif;"><div style="background: rgba(255, 255, 255, 0.95); border-radius: 20px; padding: 40px; max-width: 500px; width: 100%; box-shadow: 0 20px 60px rgba(0, 0, 0, 0.3); text-align: center;"><h2 style="color: #2d3748; margin: 0 0 10px 0; font-size: 28px; font-weight: 700;">Hide and Seek</h2><p style="color: #4a5568; margin: 0 0 30px 0; font-size: 16px; line-height: 1.6;">This game requires an online multiplayer connection. Please ensure the socket server is running.</p><div style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 20px;"><button id="hide-seek-play-online-timeout-retry" style="padding: 14px 24px; background: linear-gradient(135deg, #4A9EFF 0%, #357ABD 100%); color: white; border: none; border-radius: 10px; cursor: pointer; font-size: 16px; font-weight: 600; width: 100%; transition: transform 0.2s, box-shadow 0.2s; box-shadow: 0 4px 15px rgba(74, 158, 255, 0.3);" onmouseover="this.style.transform=\'scale(1.02)\'; this.style.boxShadow=\'0 6px 20px rgba(74, 158, 255, 0.4)\';" onmouseout="this.style.transform=\'scale(1)\'; this.style.boxShadow=\'0 4px 15px rgba(74, 158, 255, 0.3)\';"">🎮 Play Online</button><button id="hide-seek-start-server-retry" style="padding: 14px 24px; background: linear-gradient(135deg, #10B981 0%, #059669 100%); color: white; border: none; border-radius: 10px; cursor: pointer; font-size: 16px; font-weight: 600; width: 100%; transition: transform 0.2s, box-shadow 0.2s; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.3);" onmouseover="this.style.transform=\'scale(1.02)\'; this.style.boxShadow=\'0 6px 20px rgba(16, 185, 129, 0.4)\';" onmouseout="this.style.transform=\'scale(1)\'; this.style.boxShadow=\'0 4px 15px rgba(16, 185, 129, 0.3)\';"">🚀 Start Socket Server</button><button id="hide-seek-keep-trying-retry" style="padding: 14px 24px; background: linear-gradient(135deg, #F59E0B 0%, #D97706 100%); color: white; border: none; border-radius: 10px; cursor: pointer; font-size: 16px; font-weight: 600; width: 100%; transition: transform 0.2s, box-shadow 0.2s; box-shadow: 0 4px 15px rgba(245, 158, 11, 0.3);" onmouseover="this.style.transform=\'scale(1.02)\'; this.style.boxShadow=\'0 6px 20px rgba(245, 158, 11, 0.4)\';" onmouseout="this.style.transform=\'scale(1)\'; this.style.boxShadow=\'0 4px 15px rgba(245, 158, 11, 0.3)\';"">🔄 Keep Trying</button></div><p style="font-size: 14px; color: #e53e3e; margin: 0; padding: 12px; background: #fed7d7; border-radius: 8px;">⚠️ Connection timeout. Please ensure the socket server is running.</p></div></div>';
            ...
            // Show error screen
            const errorHtml = '<div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); min-height: 100vh; display: flex; align-items: center; justify-content: center; padding: 20px; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif;"><div style="background: rgba(255, 255, 255, 0.95); border-radius: 20px; padding: 40px; max-width: 500px; width: 100%; box-shadow: 0 20px 60px rgba(0, 0, 0, 0.3); text-align: center;"><h2 style="color: #2d3748; margin: 0 0 10px 0; font-size: 28px; font-weight: 700;">Hide and Seek</h2><p style="color: #4a5568; margin: 0 0 20px 0; font-size: 16px; line-height: 1.6;">Failed to start socket server.</p><p style="font-size: 14px; color: #e53e3e; margin: 0 0 30px 0; padding: 12px; background: #fed7d7; border-radius: 8px;">' + (data.error || 'Unknown error') + '</p><div style="display: flex; flex-direction: column; gap: 12px;"><button id="hide-seek-start-server-retry-error" style="padding: 14px 24px; background: linear-gradient(135deg, #10B981 0%, #059669 100%); color: white; border: none; border-radius: 10px; cursor: pointer; font-size: 16px; font-weight: 600; width: 100%; transition: transform 0.2s, box-shadow 0.2s; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.3);" onmouseover="this.style.transform=\'scale(1.02)\'; this.style.boxShadow=\'0 6px 20px rgba(16, 185, 129, 0.4)\';" onmouseout="this.style.transform=\'scale(1)\'; this.style.boxShadow=\'0 4px 15px rgba(16, 185, 129, 0.3)\';"">🔄 Try Again</button><button id="hide-seek-back-to-error" style="padding: 14px 24px; background: linear-gradient(135deg, #718096 0%, #4a5568 100%); color: white; border: none; border-radius: 10px; cursor: pointer; font-size: 16px; font-weight: 600; width: 100%; transition: transform 0.2s, box-shadow 0.2s; box-shadow: 0 4px 15px rgba(113, 128, 150, 0.3);" onmouseover="this.style.transform=\'scale(1.02)\'; this.style.boxShadow=\'0 6px 20px rgba(113, 128, 150, 0.4)\';" onmouseout="this.style.transform=\'scale(1)\'; this.style.boxShadow=\'0 4px 15px rgba(113, 128, 150, 0.3)\';"">← Back</button></div></div></div>';
...
// Wait for socket to be available (it connects asynchronously)
  ...
  const checkSocket = setInterval(() => {
    ...
    if (hasSocket) {
      ...
      clearInterval(checkSocket);
      container.innerHTML = '<div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); min-height: 100vh; display: flex; align-items: center; justify-content: center; padding: 20px; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif;"><div style="background: rgba(255, 255, 255, 0.95); border-radius: 20px; padding: 40px; max-width: 500px; width: 100%; box-shadow: 0 20px 60px rgba(0, 0, 0, 0.3); text-align: center;"><h2 style="color: #2d3748; margin: 0 0 10px 0; font-size: 28px; font-weight: 700;">Hide and Seek</h2><p style="color: #4a5568; margin: 0 0 30px 0; font-size: 16px; line-height: 1.6;">This game requires an online multiplayer connection. Please ensure the socket server is running.</p><div style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 20px;"><button id="hide-seek-play-online-timeout" style="padding: 14px 24px; background: linear-gradient(135deg, #4A9EFF 0%, #357ABD 100%); color: white; border: none; border-radius: 10px; cursor: pointer; font-size: 16px; font-weight: 600; width: 100%; transition: transform 0.2s, box-shadow 0.2s; box-shadow: 0 4px 15px rgba(74, 158, 255, 0.3);" onmouseover="this.style.transform=\'scale(1.02)\'; this.style.boxShadow=\'0 6px 20px rgba(74, 158, 255, 0.4)\';" onmouseout="this.style.transform=\'scale(1)\'; this.style.boxShadow=\'0 4px 15px rgba(74, 158, 255, 0.3)\';"">🎮 Play Online</button><button id="hide-seek-start-server" style="padding: 14px 24px; background: linear-gradient(135deg, #10B981 0%, #059669 100%); color: white; border: none; border-radius: 10px; cursor: pointer; font-size: 16px; font-weight: 600; width: 100%; transition: transform 0.2s, box-shadow 0.2s; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.3);" onmouseover="this.style.transform=\'scale(1.02)\'; this.style.boxShadow=\'0 6px 20px rgba(16, 185, 129, 0.4)\';" onmouseout="this.style.transform=\'scale(1)\'; this.style.boxShadow=\'0 4px 15px rgba(16, 185, 129, 0.3)\';"">🚀 Start Socket Server</button><button id="hide-seek-keep-trying" style="padding: 14px 24px; background: linear-gradient(135deg, #F59E0B 0%, #D97706 100%); color: white; border: none; border-radius: 10px; cursor: pointer; font-size: 16px; font-weight: 600; width: 100%; transition: transform 0.2s, box-shadow 0.2s; box-shadow: 0 4px 15px rgba(245, 158, 11, 0.3);" onmouseover="this.style.transform=\'scale(1.02)\'; this.style.boxShadow=\'0 6px 20px rgba(245, 158, 11, 0.4)\';" onmouseout="this.style.transform=\'scale(1)\'; this.style.boxShadow=\'0 4px 15px rgba(245, 158, 11, 0.3)\';"">🔄 Keep Trying</button></div><p style="font-size: 14px; color: #e53e3e; margin: 0; padding: 12px; background: #fed7d7; border-radius: 8px;">⚠️ Connection timeout. Please ensure the socket server is running.</p></div></div>';
      attachTimeoutButtons(container, checkSocket, checkCount, maxChecks);
